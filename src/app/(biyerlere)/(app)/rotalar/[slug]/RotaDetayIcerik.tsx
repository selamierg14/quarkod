  ...
  return (
    <div className="flex flex-col gap-5">
      <div>
        ...
        {rota.aciklama ? <p className="mt-1 text-small text-slate-400">{rota.aciklama}</p> : null}
      </div>
          ...
          return (
            <li key={durak.id}>
              <a
                ...
                className="flex items-center gap-3 rounded-2xl border border-slate-800 bg-slate-900/85 p-3.5"
              >
                <span
                  className={`flex h-7 w-7 shrink-0 items-center justify-center rounded-full text-[12px] font-bold ${
                    ziyaretEdildi ? "bg-[#10B981] text-white" : "bg-slate-800 text-slate-400"
                  }`}
                >
