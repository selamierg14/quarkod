  ...
  return (
    <div className="-mx-4 -mt-3 flex flex-col gap-5 pb-4">
      <div className="relative h-56 w-full bg-white/5">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#18191E] via-[#18191E]/20 to-transparent" />
        ...
        <div className="absolute inset-x-4 bottom-3 flex items-end gap-3">
          <div className="h-16 w-16 shrink-0 overflow-hidden rounded-2xl bg-[#24262E] ring-2 ring-[#18191E]">
            {mekan.logoUrl ? (
              // eslint-disable-next-line @next/next/no-img-element
          ...
          <div className="min-w-0 pb-1">
            ...
            <p className="flex items-center gap-2 text-caption text-gray-300">
      ...
      <div className="flex flex-col gap-5 px-4">
            ...
            <ul className="mt-2.5 flex flex-col gap-2">
              {mekan.etkinlikler.map((e) => (
                ...
                >
                  ...
                  {e.aciklama ? (
                    <p className="mt-1 text-small text-gray-300">{e.aciklama}</p>
                  ) : null}
                </li>
              ))}
            </ul>
            ...
            <div className="-mx-4 mt-2.5 flex gap-3 overflow-x-auto px-4 pb-1">
              {mekan.menu.bolumler
                ...
                .map((urun) => (
                  <div
                    key={urun.id}
                    className="w-32 shrink-0 overflow-hidden rounded-2xl border border-white/10 bg-[#24262E]/85"
                  >
        ...
        <section>
          ...
          {mekan.dogrulanmisYorumlar.length === 0 ? (
            <p className="mt-3 rounded-2xl border border-dashed border-white/10 p-4 text-center text-small text-gray-400">
            ...
            <ul className="mt-2.5 flex flex-col gap-2.5">
              {mekan.dogrulanmisYorumlar.map((yorum) => (
                ...
                >
                  ...
                  <p className="mt-1.5 text-small text-gray-300">{yorum.yorum}</p>
                </li>
              ))}
            </ul>
          )}
