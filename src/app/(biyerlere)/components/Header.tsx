...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-20 border-b border-white/10 bg-[#18191E]/90 px-4 pt-[max(0.75rem,env(safe-area-inset-top))] pb-3 backdrop-blur-md">
      <div className="flex items-center justify-between gap-2">
        <button
          type="button"
          onClick={konumIste}
          className="flex min-w-0 items-center gap-1.5 text-small font-medium text-white active:scale-[0.97] transition-transform duration-150 ease-out"
        >
        ...
        <div className="flex shrink-0 items-center gap-1">
          <Link
            ...
            className="flex h-11 w-11 items-center justify-center rounded-full text-gray-300 transition active:scale-[0.97] hover:bg-white/5"
          >
          ...
          <Link
            ...
            className="relative flex h-11 w-11 items-center justify-center rounded-full text-gray-300 transition active:scale-[0.97] hover:bg-white/5"
          >
            <Bell className="h-[18px] w-[18px]" aria-hidden="true" />
            {yeniSayisi ? (
              <span
                aria-hidden="true"
                className="absolute top-1 right-1 flex h-4 min-w-4 items-center justify-center rounded-full bg-[#FF6B4A] px-1 text-[10px] font-semibold text-white"
              >
